...
--
-- Name: POIs; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA "POIs";


ALTER SCHEMA "POIs" OWNER TO postgres;
...
--
-- Name: Categorie; Type: TABLE; Schema: POIs; Owner: postgres; Tablespace: 
--
...
ALTER TABLE "POIs"."Categorie" OWNER TO postgres;

--
-- Name: Checkins4sqManhattan; Type: TABLE; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE TABLE "Checkins4sqManhattan" (
    userid character varying(20) NOT NULL,
    "tweetID" character varying(20) NOT NULL,
    text character varying,
    location public.geography(Point,4326),
    "time" timestamp without time zone,
    "venueID" character varying(20),
    lat_long point,
    "4sq" character varying NOT NULL,
    "4sqExtended" character varying
);


ALTER TABLE "POIs"."Checkins4sqManhattan" OWNER TO postgres;

--
-- Name: MacroCategorie; Type: TABLE; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE TABLE "MacroCategorie" (
    "nomeMC" character varying NOT NULL
);


ALTER TABLE "POIs"."MacroCategorie" OWNER TO postgres;

--
-- Name: POIsManhattan; Type: TABLE; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE TABLE "POIsManhattan" (
    "4sqExtended" character varying NOT NULL,
    location public.geography,
    categoria character varying,
    "imgCategoria" character varying,
...
ALTER TABLE "POIs"."POIsManhattan" OWNER TO postgres;

--
-- Name: RelCatMacroCat; Type: TABLE; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE TABLE "RelCatMacroCat" (
    categoria character varying NOT NULL,
    macro_cat character varying NOT NULL
);


ALTER TABLE "POIs"."RelCatMacroCat" OWNER TO postgres;

--
-- Name: RelPOIManCategorie; Type: TABLE; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE TABLE "RelPOIManCategorie" (
    poi character varying NOT NULL,
    categoria character varying NOT NULL
);


ALTER TABLE "POIs"."RelPOIManCategorie" OWNER TO postgres;

--
-- Name: Steps; Type: MATERIALIZED VIEW; Schema: POIs; Owner: chobeat; Tablespace: 
--

CREATE MATERIALIZED VIEW "Steps" AS
 SELECT d.userid,
    d."time" AS arrival_time,
    d.location AS arrival_location,
    ( SELECT c."venueID"
           FROM "Checkins4sqManhattan" c
          WHERE (((d.userid)::text = (c.userid)::text) AND (c."time" = ( SELECT max(b."time") AS max
                   FROM "Checkins4sqManhattan" b
                  WHERE (((((d.userid)::text = (b.userid)::text) AND (b."time" < d."time")) AND (date_trunc('day'::text, b."time") = date_trunc('day'::text, d."time"))) AND ((d."venueID")::text !~~ (b."venueID")::text)))))
         LIMIT 1) AS "from",
    d."venueID" AS "to"
   FROM "Checkins4sqManhattan" d
  WHERE (d."venueID" IS NOT NULL)
  ORDER BY d."time"
  WITH NO DATA;


ALTER TABLE "POIs"."Steps" OWNER TO chobeat;

--
-- Name: Users4sqManhattan; Type: TABLE; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE TABLE "Users4sqManhattan" (
...
ALTER TABLE "POIs"."Users4sqManhattan" OWNER TO postgres;

--
-- Name: test; Type: MATERIALIZED VIEW; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE MATERIALIZED VIEW test AS
 SELECT "Checkins4sqManhattan".userid,
    "Checkins4sqManhattan"."tweetID",
    "Checkins4sqManhattan".text,
    "Checkins4sqManhattan".location,
    "Checkins4sqManhattan"."time",
    "Checkins4sqManhattan"."venueID",
    "Checkins4sqManhattan".lat_long,
    "Checkins4sqManhattan"."4sq",
    "Checkins4sqManhattan"."4sqExtended"
   FROM "Checkins4sqManhattan"
 LIMIT 5000
  WITH NO DATA;


ALTER TABLE "POIs".test OWNER TO postgres;

SET search_path = public, pg_catalog;

--
-- Name: poi_15; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE poi_15 (
    "userID" character varying(20),
    "tweetID" character varying(20),
    text character varying,
    location geography(Point,4326),
    "time" timestamp without time zone,
    "venueID" character varying(20),
    lat_long point,
    "4sq" character varying,
    "4sqExtended" character varying,
    gid_id integer,
    time_c character varying(255),
    gid_id15 integer NOT NULL
);


ALTER TABLE public.poi_15 OWNER TO postgres;

--
-- Name: poi_15_gid_id15_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE poi_15_gid_id15_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.poi_15_gid_id15_seq OWNER TO postgres;

--
-- Name: poi_15_gid_id15_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE poi_15_gid_id15_seq OWNED BY poi_15.gid_id15;


--
-- Name: poi_lunch; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE poi_lunch (
    "userID" character varying(20),
    "tweetID" character varying(20),
    text character varying,
    location geography(Point,4326),
    ...
    "4sqExtended" character varying,
    gid_id integer,
    gid_id1 integer NOT NULL,
    time_c character varying(255)
);


ALTER TABLE public.poi_lunch OWNER TO postgres;

--
-- Name: poi_lunch_gid_id1_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE poi_lunch_gid_id1_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.poi_lunch_gid_id1_seq OWNER TO postgres;

--
-- Name: poi_lunch_gid_id1_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE poi_lunch_gid_id1_seq OWNED BY poi_lunch.gid_id1;


--
-- Name: prova_id; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
CREATE TABLE prova_id (
    ...
    latitude double precision,
    longitude double precision,
    gid_id integer NOT NULL
);


ALTER TABLE public.prova_id OWNER TO postgres;

--
-- Name: prova_id_gid_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE prova_id_gid_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.prova_id_gid_id_seq OWNER TO postgres;

--
-- Name: prova_id_gid_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE prova_id_gid_id_seq OWNED BY prova_id.gid_id;


--
-- Name: testqgis; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE testqgis (
    "4sq" character varying,
    "nrCheckins" bigint,
    "nrUsers" bigint,
    location geography,
...
ALTER TABLE public.testqgis OWNER TO postgres;

--
-- Name: testqgis1; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE testqgis1 (
    "userID" character varying(20),
    "tweetID" character varying(20),
    text character varying,
    location geography(Point,4326),
...
ALTER TABLE public.testqgis1 OWNER TO postgres;

--
-- Name: testqgis1_gid_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE testqgis1_gid_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.testqgis1_gid_id_seq OWNER TO postgres;

--
-- Name: testqgis1_gid_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE testqgis1_gid_id_seq OWNED BY testqgis1.gid_id;


--
-- Name: testqgis_gid_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE testqgis_gid_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.testqgis_gid_id_seq OWNER TO postgres;

--
-- Name: testqgis_gid_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE testqgis_gid_id_seq OWNED BY testqgis.gid_id;


--
-- Name: gid_id15; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY poi_15 ALTER COLUMN gid_id15 SET DEFAULT nextval('poi_15_gid_id15_seq'::regclass);


--
-- Name: gid_id1; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY poi_lunch ALTER COLUMN gid_id1 SET DEFAULT nextval('poi_lunch_gid_id1_seq'::regclass);


--
-- Name: gid_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY prova_id ALTER COLUMN gid_id SET DEFAULT nextval('prova_id_gid_id_seq'::regclass);
...
ALTER TABLE ONLY testqgis ALTER COLUMN gid_id SET DEFAULT nextval('testqgis_gid_id_seq'::regclass);
...
ALTER TABLE ONLY testqgis1 ALTER COLUMN gid_id SET DEFAULT nextval('testqgis1_gid_id_seq'::regclass);


SET search_path = "POIs", pg_catalog;

--
-- Name: FKcMc; Type: CONSTRAINT; Schema: POIs; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "RelCatMacroCat"
    ADD CONSTRAINT "FKcMc" PRIMARY KEY (categoria, macro_cat);


--
-- Name: PK4sq; Type: CONSTRAINT; Schema: POIs; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "Checkins4sqManhattan"
    ADD CONSTRAINT "PK4sq" PRIMARY KEY (userid, "tweetID");


--
-- Name: PKcat; Type: CONSTRAINT; Schema: POIs; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "Categorie"
    ADD CONSTRAINT "PKcat" PRIMARY KEY ("Categoria");


--
-- Name: PKmacroCat; Type: CONSTRAINT; Schema: POIs; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "MacroCategorie"
    ADD CONSTRAINT "PKmacroCat" PRIMARY KEY ("nomeMC");


--
-- Name: PKpoicat; Type: CONSTRAINT; Schema: POIs; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "RelPOIManCategorie"
    ADD CONSTRAINT "PKpoicat" PRIMARY KEY (poi, categoria);


--
-- Name: PKuser; Type: CONSTRAINT; Schema: POIs; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "Users4sqManhattan"
    ADD CONSTRAINT "PKuser" PRIMARY KEY ("userID");


--
-- Name: POIsManhattan_pkey; Type: CONSTRAINT; Schema: POIs; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "POIsManhattan"
    ADD CONSTRAINT "POIsManhattan_pkey" PRIMARY KEY ("4sqExtended");


--
-- Name: geoindex; Type: INDEX; Schema: POIs; Owner: postgres; Tablespace: 
--

CREATE INDEX geoindex ON "Checkins4sqManhattan" USING gist (location);


--
-- Name: FKcat; Type: FK CONSTRAINT; Schema: POIs; Owner: postgres
--

ALTER TABLE ONLY "RelCatMacroCat"
    ADD CONSTRAINT "FKcat" FOREIGN KEY (categoria) REFERENCES "Categorie"("Categoria");
...
--
-- Name: FKmacroCat; Type: FK CONSTRAINT; Schema: POIs; Owner: postgres
--

ALTER TABLE ONLY "RelCatMacroCat"
    ADD CONSTRAINT "FKmacroCat" FOREIGN KEY (macro_cat) REFERENCES "MacroCategorie"("nomeMC");


--
-- Name: FKuser; Type: FK CONSTRAINT; Schema: POIs; Owner: postgres
--

ALTER TABLE ONLY "Checkins4sqManhattan"
    ADD CONSTRAINT "FKuser" FOREIGN KEY (userid) REFERENCES "Users4sqManhattan"("userID");


--
-- Name: POIs; Type: ACL; Schema: -; Owner: postgres
--

REVOKE ALL ON SCHEMA "POIs" FROM PUBLIC;
REVOKE ALL ON SCHEMA "POIs" FROM postgres;
GRANT ALL ON SCHEMA "POIs" TO postgres;
GRANT ALL ON SCHEMA "POIs" TO PUBLIC;
...
--
-- Name: get_routes_t(character varying); Type: FUNCTION; Schema: POIs; Owner: chobeat
--

CREATE FUNCTION get_routes_t("user" character varying DEFAULT 0) RETURNS TABLE(loc public.geography)
    LANGUAGE plpgsql
    AS $$
BEGIN

   RETURN QUERY
     SELECT arrival_location FROM "POIs".steps where userid=user  limit 100;

END
$$;


ALTER FUNCTION "POIs".get_routes_t("user" character varying) OWNER TO chobeat;
...
--
-- Name: aggregated_steps; Type: VIEW; Schema: POIs; Owner: postgres
--

CREATE VIEW aggregated_steps AS
 SELECT a."from",
    a."to",
    count(*) AS routes
   FROM steps a
...
ALTER TABLE "POIs".aggregated_steps OWNER TO postgres;

--
-- Name: numbered_routes; Type: VIEW; Schema: POIs; Owner: chobeat
--

CREATE VIEW numbered_routes AS
 SELECT b.userid,
    b.hour,
    b."from",
    b."to",
    row_number() OVER (PARTITION BY b.userid, b.hour) AS row_number
   FROM ( SELECT steps.userid,
            steps.arrival_time,
            steps.arrival_location,
            steps."from",
            steps."to",
            date_part('hour'::text, steps.arrival_time) AS hour
           FROM steps) b;


ALTER TABLE "POIs".numbered_routes OWNER TO chobeat;

--
-- Name: routes; Type: VIEW; Schema: POIs; Owner: chobeat
--

CREATE VIEW routes AS
 SELECT b.userid,
    b.day,
    min(b.arrival_time) AS start,
    max(b.arrival_time) AS "end",
    public.st_makeline((b.arrival_location)::public.geometry) AS route
   FROM ( SELECT steps.userid,
            steps.arrival_time,
            steps.arrival_location,
            steps."from",
            steps."to",
            date_trunc('day'::text, steps.arrival_time) AS day
           FROM steps
          ORDER BY steps.arrival_time) b
  GROUP BY b.userid, b.day
 HAVING (count(*) > 1)
  ORDER BY min(b.arrival_time);


ALTER TABLE "POIs".routes OWNER TO chobeat;
...
--
-- Name: routePopularity(timestamp without time zone, timestamp without time zone, public.geometry, double precision); Type: FUNCTION; Schema: POIs; Owner: chobeat
--

CREATE FUNCTION "routePopularity"(start timestamp without time zone, "end" timestamp without time zone, route public.geometry, distance double precision) RETURNS double precision
    LANGUAGE plpgsql
    AS $$BEGIN
...
ALTER FUNCTION "POIs"."routePopularity"(start timestamp without time zone, "end" timestamp without time zone, route public.geometry, distance double precision) OWNER TO chobeat;

--
-- Name: routePopularity2(double precision, double precision, bigint); Type: FUNCTION; Schema: POIs; Owner: chobeat
--

CREATE FUNCTION "routePopularity2"(distance double precision, length double precision, steps bigint) RETURNS double precision
    LANGUAGE plpgsql
    AS $$BEGIN
...
ALTER FUNCTION "POIs"."routePopularity2"(distance double precision, length double precision, steps bigint) OWNER TO chobeat;

--
-- Name: routePopularity2(double precision, double precision, integer); Type: FUNCTION; Schema: POIs; Owner: chobeat
--

CREATE FUNCTION "routePopularity2"(distance double precision, length double precision, steps integer) RETURNS double precision
    LANGUAGE plpgsql
    AS $$BEGIN
return steps/(length*distance);
END;$$;


ALTER FUNCTION "POIs"."routePopularity2"(distance double precision, length double precision, steps integer) OWNER TO chobeat;
...
--
-- Name: routes; Type: MATERIALIZED VIEW; Schema: POIs; Owner: chobeat; Tablespace: 
--

CREATE MATERIALIZED VIEW routes AS
 SELECT DISTINCT routes.userid,
    routes.length,
    routes.day,
    routes.start,
    routes."end",
    ...
    routes."from",
    added_to."to"
   FROM (( SELECT DISTINCT routes_1.userid,
            routes_1.day,
            routes_1.start,
            routes_1."end",
            routes_1.steps,
            routes_1.route,
            public.st_length((routes_1.route)::public.geography, true) AS length,
            added_from."to" AS "from"
           FROM (( SELECT b.userid,
                    b.day,
                    min(b.arrival_time) AS start,
                    max(b.arrival_time) AS "end",
                    count(*) AS steps,
                    public.st_makeline(public.st_snaptogrid((b.arrival_location)::public.geometry, (0.01)::double precision)) AS route
                   FROM ( SELECT steps.userid,
                            steps.arrival_time,
                            steps.arrival_location,
                            steps."from",
                            ...
                            date_trunc('day'::text, steps.arrival_time) AS day
                           FROM steps
                          WHERE ((steps."from")::text <> (steps."to")::text)
                          ORDER BY steps.arrival_time) b
                  GROUP BY b.userid, b.day
                 HAVING (count(*) > 3)
                  ORDER BY min(b.arrival_time)) routes_1
     CROSS JOIN steps added_from)
     WHERE ((routes_1.start = added_from.arrival_time) AND ((routes_1.userid)::text = (added_from.userid)::text))) routes
  CROSS JOIN steps added_to)
  WHERE ((routes."end" = added_to.arrival_time) AND ((routes.userid)::text = (added_to.userid)::text))
  WITH NO DATA;
...
--
-- Name: steps2; Type: MATERIALIZED VIEW; Schema: POIs; Owner: chobeat; Tablespace: 
--

CREATE MATERIALIZED VIEW steps2 AS
 SELECT d.userid,
    d."time" AS arrival_time,
    d.location AS arrival_location,
    ( SELECT c."4sqExtended"
           FROM "Checkins4sqManhattan" c
          WHERE (((d.userid)::text = (c.userid)::text) AND (c."time" = ( SELECT max(b."time") AS max
                   FROM "Checkins4sqManhattan" b
                  WHERE (((((d.userid)::text = (b.userid)::text) AND (b."time" < d."time")) AND (date_trunc('day'::text, b."time") = date_trunc('day'::text, d."time"))) AND ((d."4sqExtended")::text !~~ (b."4sqExtended")::text)))))
         LIMIT 1) AS "from",
    d."4sqExtended" AS "to"
   FROM "Checkins4sqManhattan" d
  WHERE (d."4sqExtended" IS NOT NULL)
  ORDER BY d."time"
  WITH NO DATA;


ALTER TABLE "POIs".steps2 OWNER TO chobeat;

--
-- Name: routes2; Type: MATERIALIZED VIEW; Schema: POIs; Owner: chobeat; Tablespace: 
--

CREATE MATERIALIZED VIEW routes2 AS
 SELECT DISTINCT row_number() OVER (ORDER BY steps.userid) AS id,
    steps.userid,
    min(steps.arrival_time) AS min,
    max(steps.arrival_time) AS max,
    date_trunc('day'::text, steps.arrival_time) AS day,
    public.st_makeline(public.st_snaptogrid((steps.arrival_location)::public.geometry, (0.01)::double precision)) AS shape,
    array_agg(steps."to") AS path,
    array_agg(steps.arrival_location) AS points
   FROM steps2 steps
  GROUP BY steps.userid, date_trunc('day'::text, steps.arrival_time)
 HAVING (count(*) > 3)
  WITH NO DATA;


ALTER TABLE "POIs".routes2 OWNER TO chobeat;
...
CREATE MATERIALIZED VIEW routes2 AS
 SELECT DISTINCT row_number() OVER (ORDER BY steps.userid) AS id,
    ...
    max(steps.arrival_time) AS max,
    date_trunc('day'::text, steps.arrival_time) AS day,
    public.st_astext(public.st_makeline(public.st_snaptogrid((steps.arrival_location)::public.geometry, (0.01)::double precision))) AS shape,
    array_agg(steps."to") AS path,
    array_agg(public.st_astext(steps.arrival_location)) AS points,
    array_agg(steps.nome) AS path_name
   FROM ( SELECT s.userid,
            ...
            p.nome
           FROM (steps2 s
      JOIN "POIsManhattan" p ON (((s."to")::text = (p."4sqExtended")::text)))
     WHERE (p.nome IS NOT NULL)) steps
  GROUP BY steps.userid, date_trunc('day'::text, steps.arrival_time)
 HAVING (count(*) > 3)
  WITH NO DATA;
...
--
-- Name: get_cat(character varying[]); Type: FUNCTION; Schema: POIs; Owner: postgres
--

CREATE FUNCTION get_cat(path character varying[]) RETURNS character varying
    LANGUAGE sql
    AS $_$
select macro_cat from

(select mode(cat.categoria) as categoria from (
select categoria from (select unnest($1)as poi) as poi 
inner join "POIs"."RelPOIManCategorie" as r on r.poi=poi.poi ) as cat

)

 as cat natural join "POIs"."RelCatMacroCat" as macro
$_$;


ALTER FUNCTION "POIs".get_cat(path character varying[]) OWNER TO postgres;

--
-- Name: get_category(integer); Type: FUNCTION; Schema: POIs; Owner: postgres
--

CREATE FUNCTION get_category(id integer DEFAULT (-1)) RETURNS character varying
    LANGUAGE sql
    AS $_$
select macro_cat from

(select id, mode(cat.categoria) as categoria from (select unnest(path) as poi,r.id

from "POIs".routes2 as r where r.id=$1) as pointsToRoute natural join (select distinct on(poi) poi, categoria from "POIs"."RelPOIManCategorie") as cat group by id) as cat natural join "POIs"."RelCatMacroCat" as macro
$_$;


ALTER FUNCTION "POIs".get_category(id integer) OWNER TO postgres;
...
--
-- Name: _final_mode(anyarray); Type: FUNCTION; Schema: public; Owner: chobeat
--
...
ALTER FUNCTION public._final_mode(anyarray) OWNER TO chobeat;
...
--
-- Name: mode(anyelement); Type: AGGREGATE; Schema: public; Owner: chobeat
--
...
ALTER AGGREGATE public.mode(anyelement) OWNER TO chobeat;
...
CREATE MATERIALIZED VIEW routes2 AS
 SELECT DISTINCT row_number() OVER (ORDER BY steps.userid) AS id,
    ...
    array_agg(public.st_astext(steps.arrival_location)) AS points,
    array_agg(steps.nome) AS path_name,
    get_cat(array_agg(steps."to")) AS category
   FROM ( SELECT s.userid,
            s.arrival_time,
            s.arrival_location,
            s."from",
...
--
-- Name: routePopularity(double precision); Type: FUNCTION; Schema: POIs; Owner: chobeat
--

CREATE FUNCTION "routePopularity"(distance double precision DEFAULT 0) RETURNS double precision
    LANGUAGE plpgsql
    AS $$BEGIN

return 0.1+1/distance;

END;$$;


ALTER FUNCTION "POIs"."routePopularity"(distance double precision) OWNER TO chobeat;
...
--
-- Name: stepsToPopularity; Type: MATERIALIZED VIEW; Schema: POIs; Owner: chobeat; Tablespace: 
--

CREATE MATERIALIZED VIEW "stepsToPopularity" AS
 SELECT steps2."from",
    steps2."to",
    count(*) AS popularity
   FROM steps2
  GROUP BY steps2."from", steps2."to"
  WITH NO DATA;


ALTER TABLE "POIs"."stepsToPopularity" OWNER TO chobeat;
...
CREATE MATERIALIZED VIEW routes2 AS
 SELECT DISTINCT row_number() OVER (ORDER BY steps.userid) AS id,
    ...
    array_agg(steps.nome) AS path_name,
    get_cat(array_agg(steps."to")) AS category,
    min(p.popularity) AS popularity
   FROM (( SELECT s.userid,
            s.arrival_time,
            s.arrival_location,
            s."from",
            ...
            p_1.nome
           FROM (steps2 s
      JOIN "POIsManhattan" p_1 ON (((s."to")::text = (p_1."4sqExtended")::text)))
     WHERE (p_1.nome IS NOT NULL)) steps
  CROSS JOIN "stepsToPopularity" p)
  WHERE (((p."to")::text = (steps."to")::text) AND ((p."from")::text = (steps."from")::text))
  GROUP BY steps.userid, date_trunc('day'::text, steps.arrival_time)
 HAVING (count(*) > 3)
  WITH NO DATA;
...
--
-- Name: Users; Type: SCHEMA; Schema: -; Owner: chobeat
--

CREATE SCHEMA "Users";


ALTER SCHEMA "Users" OWNER TO chobeat;
...
CREATE MATERIALIZED VIEW routes2 AS
 SELECT DISTINCT row_number() OVER (ORDER BY steps.userid) AS id,
    steps.userid,
    min(steps.arrival_time) AS start_time,
    max(steps.arrival_time) AS arrival_time,
    date_trunc('day'::text, steps.arrival_time) AS day,
    public.st_astext(public.st_makeline(public.st_snaptogrid((steps.arrival_location)::public.geometry, (0.0001)::double precision))) AS shape,
    array_agg(steps."to") AS path,
    array_agg(public.st_astext(steps.arrival_location)) AS points,
    array_agg(steps.nome) AS path_name,
    get_cat(array_agg(steps."to")) AS category,
...
--
-- Name: interests; Type: TABLE; Schema: Users; Owner: chobeat; Tablespace: 
--
...
ALTER TABLE "Users".interests OWNER TO chobeat;
...
--
-- Name: unique; Type: CONSTRAINT; Schema: Users; Owner: chobeat; Tablespace: 
--

ALTER TABLE ONLY interests
    ADD CONSTRAINT "unique" UNIQUE (userid, interest);
...
--
-- Name: interests_interest_fkey; Type: FK CONSTRAINT; Schema: Users; Owner: chobeat
--

ALTER TABLE ONLY interests
    ADD CONSTRAINT interests_interest_fkey FOREIGN KEY (interest) REFERENCES "POIs"."MacroCategorie"("nomeMC");
...
--
-- Name: get_interests(); Type: FUNCTION; Schema: Users; Owner: chobeat
--

CREATE FUNCTION get_interests() RETURNS character varying[]
    LANGUAGE sql
    AS $$select array_agg(interest) from (select *, row_number() over (partition by interest order by time desc) as row from 	(select interest, max(time) as time,valid from "Users".interests where userid='simone.robutti@gmail.com'
				group by interest,userid,valid order by time desc) as res) as res where row=1 and valid=true group by interest;	
$$;


ALTER FUNCTION "Users".get_interests() OWNER TO chobeat;

--
-- Name: get_interests(character varying); Type: FUNCTION; Schema: Users; Owner: chobeat
--

CREATE FUNCTION get_interests(uid character varying) RETURNS character varying[]
    LANGUAGE sql
    AS $_$select array_agg(interest) as interests from (select *, row_number() over (partition by interest order by time desc) as row from 	(select userid,interest, max(time) as time,valid from "Users".interests where userid=$1
				group by interest,userid,valid order by time desc) as res) as res where row=1 and valid=true group by userid;	
$_$;


ALTER FUNCTION "Users".get_interests(uid character varying) OWNER TO chobeat;
